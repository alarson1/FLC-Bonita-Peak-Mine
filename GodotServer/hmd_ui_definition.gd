	...
	"dropdowns": [
		...
		},
		{
			...
			"options": {
				...
				"D_Level_Updated": 13,
				"E_Level_Updated": 15,
				"F_Level_Updated_2": 16,
				"Sunnyside_G_Level_Updated": 17,
				"Sunnyside_HLevel": 18,
				"Sunnyside_I_Level": 19,
				"Sunnyside_ATLevel": 20,
				"AmericanTunnel": 21,
				"RSE_2890_Drift": 22,
				"RSE_3710_Drift": 23,
				"Terry_Shaft": 24,
				"Washington_VerticalShaft": 25,
				"AT_WashingtonShaft": 26,
				"Gold_Prince_Shaft": 27,
				"Sunnyside_Raises_OrePass": 28,
			}
		},
		{
