...
func _ready():
	...
	# Connects hmd UI elements to this script
	$NoodlesRoot/UIRoot/UIgrabbable/hmdUI.parameter_changed.connect(_on_ui_parameter_updated)
...
func _on_ui_parameter_updated(param: String, value: Variant):
	if param == "button1":
		$NoodlesRoot/Object.visible = !$NoodlesRoot/Object.visible
